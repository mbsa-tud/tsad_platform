...
5. Network architectures of deep-learning models could be checked in more detail or updated. For example the TCN-AE currently only accepts window-sizes that are divisible by 4. Do batch normalization layers make sense (used in ResNet and Hybrid models for example)?
