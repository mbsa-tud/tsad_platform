function anomalyScores = detectWithS_wrapper(options, Mdl, XTest, YTest, labels)
%DETECTWITHS
%
...
if options.isMultivariate
    ...
    anomalyScores = detectWithS(options, Mdl_tmp, XTest{1, 1}, YTest{1, 1}, labels);
else
    ...
    for i = 1:numChannels
        ...
        anomalyScores_tmp  = detectWithS(options, Mdl_tmp, XTest{1, i}, YTest{1, i}, labels);
