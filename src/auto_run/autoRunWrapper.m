function finalTable =  autoRunWrapper(datasetPath, models, preprocMethod, ratioTestVal, thresholds, dynamicThresholdSettings, trainingPlots, parallelEnabled)
...
for dataset_idx = 1:length(indices)    
    ...
    [tmpScores, testFileNames] = trainAndEvaluateAllModels(dataPath, models, ...
        ...
        trainingPlots, parallelEnabled, false, [], [], []);
