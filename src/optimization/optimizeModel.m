function results = optimizeModel(optVars, models, dataTrain, labelsTrain, dataValTest, labelsValTest, dataTest, labelsTest, ratioValTest, thresholds, cmpScore, iterations, exportLogData)
%OPTIMIZEMODEL
%
