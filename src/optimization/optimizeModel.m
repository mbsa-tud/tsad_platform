function results = optimizeModel(optVars, models, dataTrain, labelsTrain, dataValTest, labelsValTest, dataTest, labelsTest, thresholds, dynamicThresholdSettings, cmpScore, iterations, trainingPlots, exportLogData)
%OPTIMIZEMODEL
%
